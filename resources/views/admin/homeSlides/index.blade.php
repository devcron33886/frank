                                            ...
                                            <td>
                                                @can('home_slide_show')
                                                    <a class="btn btn-xs btn-primary"
                                                        href="{{ route('admin.home-slides.show', $homeSlide->id) }}">
                                                        {{ trans('global.view') }}
                                                    </a>
                                                @endcan
                                                ...
                                                @can('home_slide_edit')
                                                    <a class="btn btn-xs btn-info"
                                                        href="{{ route('admin.home-slides.edit', $homeSlide->id) }}">
                                                        {{ trans('global.edit') }}
                                                    </a>
                                                @endcan

                                                @can('home_slide_delete')
                                                    <form action="{{ route('admin.home-slides.destroy', $homeSlide->id) }}"
                                                        method="POST"
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            let table = $('.datatable-HomeSlide:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
