...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.homeSlide.title_singular') }}
    </div>
        ...
        <form method="POST" action="{{ route("admin.home-slides.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('show_text') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="show_text" id="show_text" value="1" {{ old('show_text', 0) == 1 ? 'checked' : '' }}>
