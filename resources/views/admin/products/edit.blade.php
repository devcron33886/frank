    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.update", [$product->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('measure') ? 'is-invalid' : '' }}" type="text" name="measure" id="measure" value="{{ old('measure', $product->measure) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('min_stock') ? 'is-invalid' : '' }}" type="text" name="min_stock" id="min_stock" value="{{ old('min_stock', $product->min_stock) }}">
