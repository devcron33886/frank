                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="form-group col-6">
                                    ...
                                    <input class="form-control {{ $errors->has('qty') ? 'is-invalid' : '' }}"
                                        type="text" name="qty" id="qty" value="{{ old('qty', '') }}" required>
                                    @if ($errors->has('qty'))
                                ...
                                <div class="form-group col-6">
                                    <label class="required"
                                        for="price">{{ trans('cruds.product.fields.price') }}</label>
                            ...
                            <div class="row">
                                <div class="form-group col-6">
                                    <label class="required"
                                        for="measure">{{ trans('cruds.product.fields.measure') }}</label>
                                    <input class="form-control {{ $errors->has('measure') ? 'is-invalid' : '' }}"
                                        type="text" name="measure" id="measure" value="{{ old('measure', '') }}"
                                        required>
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input class="form-control {{ $errors->has('min_stock') ? 'is-invalid' : '' }}"
                                        type="text" name="min_stock" id="min_stock" value="{{ old('min_stock', '') }}">
