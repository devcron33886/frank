            ...
            <form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="form-group col-6">
                        ...
                        <input class="form-control {{ $errors->has('qty') ? 'is-invalid' : '' }}" type="text"
                            name="qty" id="qty" value="{{ old('qty', '') }}" required>
                        @if ($errors->has('qty'))
                ...
                <div class="row">
                    <div class="form-group col-6">
                        ...
                        <input class="form-control {{ $errors->has('measure') ? 'is-invalid' : '' }}" type="text"
                            name="measure" id="measure" value="{{ old('measure', '') }}" required>
                    ...
                    <div class="form-group col-6">
                        ...
                        <input class="form-control {{ $errors->has('min_stock') ? 'is-invalid' : '' }}" type="text"
                ...
                <div class="row">
                    ...
                    <div class="form-group col-6">
                        ...
                        <input class="form-control {{ $errors->has('discount') ? 'is-invalid' : '' }}" type="number"
                            name="discount" id="discount" value="{{ old('discount', '') }}" step="1">
