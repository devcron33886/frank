                        ...
                        <div class="panel-body p-0 table-responsive">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <th colspan="3" class="text-success">
                                        + {{ number_format(\App\Models\Setting::first()->shipping_amount) }} Rwf
                                    </th>
                                </tr>
                                <tr>
                                    <th>
                                    ...
                                    <th colspan="3" class="text-success">
                                        <span class="label label-success">{{ number_format(Cart::getSubTotal()+\App\Models\Setting::first()->shipping_amount) }} Rwf</span>
                                    </th>
                                </tr>
                                </tfoot>
